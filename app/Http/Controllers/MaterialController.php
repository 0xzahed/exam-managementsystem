...
class MaterialController extends Controller
{
    ...
    public function store(Request $request, Course $course)
    {
        ...
        if ($request->material_type === 'file') {
            ...
            $request->validate([
                'file' => 'file|mimes:pdf,ppt,pptx,doc,docx,jpg,jpeg,png,gif|max:10240'
            ]);
        ...
        $materialData = [
            ...
            'type' => $request->material_type ?? 'text',
            'uploaded_by' => Auth::id(),
        ...
        if ($request->hasFile('file')) {
            ...
            // Use original filename for Google Drive - the drive service will handle naming
